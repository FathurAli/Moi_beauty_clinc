			...
			<div class="col-md-9">
				<div class="row portfolio_container">
					...
					<div class="col-md-4 photography">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp">
					...
					<div class="col-md-4 fashion logo">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".2s">
					...
					<div class="col-md-4 ads graphics">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".3s">
					...
					<div class="col-md-4 fashion ads">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".4s">
							<img src="assets/img/work-1.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
					...
					<div class="col-md-4 graphics ads">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".5s">
							<img src="assets/img/work-3.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>iron man</span>
					...
					<div class="col-md-4 logo web photography">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".6s">
							<img src="assets/img/work-2.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>iron man</span>
					...
					<!-- single work -->
					<div class="col-md-4 ads graphics">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".7s">
							<img src="assets/img/work-2.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>iron man</span>
					...
					<div class="col-md-4 web fashion photography">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".8s">
							<img src="assets/img/work-3.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>iron man</span>
					...
					<!-- single work -->
					<div class="col-md-4 fashion logo">
						<a href="single-project.blade.php" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".9s">
							<img src="assets/img/work-1.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>iron man</span>
				...
				<div class="row">
					<nav class="footer-nav">
						<ul>
							...
							<li><a href="contact.blade.php" class="animsition-link link">contact us</a></li>
						</ul>
					</nav>
				</div>
			</div>
